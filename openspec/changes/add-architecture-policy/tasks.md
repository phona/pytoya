## 1. Spec deltas + policy docs
- [ ] 1.1 Write architecture policy proposal + design doc
- [ ] 1.2 Update delta specs (projects, json-schema-extraction, manifest-filtering, validation-scripts, backend-standards)
- [ ] 1.3 Validate OpenSpec change (`openspec validate add-architecture-policy --strict`)

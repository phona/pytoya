...
- [x] 1.1 Write architecture policy proposal + design doc
- [x] 1.2 Update delta specs (projects, json-schema-extraction, manifest-filtering, validation-scripts, backend-standards)

...
- [x] 5.1 Create manifests module (manifests.module.ts, manifests.service.ts, manifests.controller.ts)
- [x] 5.2 Create Manifest entity with file_path field
- [x] 5.3 Implement single file upload API endpoint

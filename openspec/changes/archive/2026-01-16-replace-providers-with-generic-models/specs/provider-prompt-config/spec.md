# provider-prompt-config Specification Delta
...
This requirement is replaced by the new `models` specification. See `specs/models/spec.md` for the new model management requirements.

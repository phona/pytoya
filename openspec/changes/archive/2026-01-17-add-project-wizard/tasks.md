...
- [x] 1.1 Add prompt optimization endpoint to extraction service
...
- [x] 2.1.1 Create reusable dialog component
...
- [x] 2.1.2 Update existing forms to use dialog pattern
...
- [x] 2.2.1 Create multi-step wizard component
...
- [x] 2.2 Implement Step 1 - Basic info
  - Form fields for name and description
  - Validation
- [x] 2.3 Implement Step 2 - Strategy selection
  - Radio/buttons for schema-based vs prompt-based
  - Branch logic for next step
- [x] 2.4 Implement Step 3a - Schema builder
...
- [x] 2.5 Implement Step 3b - Prompt optimization
  - Text area for user to describe requirements
  - Call to prompt optimization endpoint
  - Display generated prompt in editor
  - Allow manual editing
  - Regenerate button
- [x] 2.6 Implement Step 4 - Model selection
  - Display available OCR models
  - Display available LLM models
  - Selection interface
  - Show test status if available
- [x] 2.7 Implement Step 5 - Review and create
  - Display summary of all selections
  - Back navigation to previous steps
  - Create project API call
  - Redirect to project detail on success
- [x] 2.8 Update sidebar navigation
  - Remove Schemas, Prompts, Validation Scripts links
  - Keep Projects, Models, Settings
  - Update `SidebarNav.tsx`
- [x] 2.9 Handle existing pages
  - Remove or make admin-only: SchemasPage, PromptsPage, ValidationScriptsPage
  - Update router configuration
- [x] 2.10 Add project detail enhancements
  - Add validation scripts section to project detail page
  - Allow inline management of validation rules

## 3. Testing

- [x] 3.1 Write unit tests for ProjectWizard component
- [x] 3.2 Write unit tests for each wizard step
- [x] 3.3 Write integration tests for prompt optimization (covered by extraction service tests)
- [x] 3.4 Write E2E tests for complete project creation flow (skipped per user request: unit tests only)
- [x] 3.5 Test navigation and state persistence across wizard steps

## 4. Documentation

- [x] 4.1 Update `docs/WEB_APP.md` with wizard flow
- [x] 4.2 Add project creation guide
- [x] 4.3 Update API documentation for prompt optimization endpoint

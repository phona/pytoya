...
- [x] 7.5 Upload (mixed batch): new + duplicate + failure summary counts are correct (use-case)
...
- [x] 7.12 Schema/rules impact: next extraction uses updated schema/rules/validation scripts (use-case)
- [x] 7.13 Optional: export selected/filtered uses correct filters + columns (use-case)

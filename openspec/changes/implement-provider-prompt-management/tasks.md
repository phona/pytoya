...
- [ ] 8.11 Create prompts list page (app/(dashboard)/prompts/page.tsx)
- [ ] 8.12 Build ProviderForm component
- [ ] 8.13 Build ProviderList component
- [ ] 8.14 Build PromptEditor component with variable suggestions
- [ ] 8.15 Add project settings UI for default provider/prompt
- [ ] 8.16 Test provider and prompt management flow

...
- `src/apps/web/src/routes/dashboard/SchemaDetailPage.tsx` (Schema edit)
- `src/apps/web/src/routes/dashboard/ProjectSettingsSchemaPage.tsx` (Schema edit)
- `src/apps/web/src/routes/dashboard/PromptsPage.tsx` (Prompt create/edit)
- `src/apps/web/src/routes/dashboard/ValidationScriptsPage.tsx` (Validation script create/edit)
...
- Prompt management: convert Prompt create/edit into a side-sheet dialog.

...
export class PaddleOcrExtractor extends BaseTextExtractor<PaddleOcrConfig> {
  static metadata: ExtractorMetadata = {
    ...
    promptContribution: 'INSTRUCTION: I provide text boxes from PaddleOCR with confidence scores and positions. Each box includes: text, confidence (0-1), bbox [x, y, w, h].',
  };

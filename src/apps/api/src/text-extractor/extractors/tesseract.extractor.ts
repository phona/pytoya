...
export class TesseractExtractor extends BaseTextExtractor<TesseractConfig> {
  static metadata: ExtractorMetadata = {
    ...
    promptContribution: 'INSTRUCTION: I provide text extracted using Tesseract OCR with per-word confidence scores. Each box includes: text, confidence (0-100), bbox [x, y, w, h].',
  };
